...
st.markdown("<h4 style='text-align: center; '>Discover the perfect match of foods with your wine by answering these 4 questions</h4>", unsafe_allow_html=True)
...
Type  = st.selectbox('Select the type of the wine', options=['Red', 'White', 'Rose', 'Sparkling', 'Dessert/Port', 'Dessert'])
...
#     with col: st.button(f"Button #{i}", use_container_width=True, type=button_type)
