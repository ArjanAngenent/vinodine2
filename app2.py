...
Type  = st.selectbox('Select the type of the wine', ['Red', 'White', 'Rose', 'Sparkling', 'Dessert/Port', 'Dessert'])
...
Grapes = st.multiselect("Choose the name of the grape(s)", grapes)
